...
// node_modules/vue3-plugin-bootstrap5/dist/vb-plugin.esm.js
var VbAlert = {
...
var VbModal = {
  createIsHandler(Modal, el, binding, baseOptions) {
    ...
    let moveShownModalBehind = () => {
      ...
      modalsVisible.forEach((visibleModalEl) => {
    ...
    return {
      ...
      beforeUnmount() {
        ...
        if (ins && (ins._isShown || ins._isTransitioning)) {
          if (el.classList.contains("fade")) el.classList.remove("fade");
  ...
  return {
    ...
    install(app) {
      ...
      let baseOptions = Object.assign({
        vbModalBaseZindex: null
        // default null means that5 we won't alter zindex
      }, options);
      let handlerConfs = {
        ...
        pill: { bsObject: bootstrapObjects.Tab, handlerObject: VbTab },
        // special case for tab
        list: { bsObject: bootstrapObjects.Tab, handlerObject: VbTab },
        // special case for tab
      ...
      app.directive("vb-is", {
        created(el, binding) {
          ...
          if (handlerConf && handlerConf.bsObject && handlerConf.handlerObject && handlerConf.handlerObject.createIsHandler) {
...
//# sourceMappingURL=vue3-plugin-bootstrap5.js.map
