...
const filteredSubCategories = computed(() => {
  ...
  return props.subCategories.filter(
    (subCat) =>
      (subCat.name &&
        subCat.name.toLowerCase().includes(searchQuery.value.toLowerCase())) ||
      (subCat.category &&
    ...
    <section class="app-user-list mb-5">
      ...
      <div class="card rounded-0">
        <div class="card-datatable table-responsive p-0">
          ...
          <div
            class="p-5 bg-white d-flex align-items-center justify-content-between"
          >
    ...
    <Modal id="addCategory" v-vb-is:modal>
      <div>
        ...
        <form @submit.prevent="addCategory">
          ...
          <div class="mb-3">
            <InputLabel for="name" value="Category Name" class="d-block mb-2" />

            <TextInput class="bt-border-color w-100 p-2" v-model="form.name" />
            <InputError :message="errors.name" />
          </div>
          <div class="mb-4">
            <InputLabel for="name" value="Add Image" class="d-block mb-2" />
            <div class="category-image">
              <label for="category-image">
                <i class="bi bi-cloud-arrow-up"></i>
                <span>Upload Image</span>
                <TextInput type="file" id="category-image" @change="image" />
              </label>
          ...
          <div class="mb-3">
            <InputLabel
              ...
              class="d-block mb-2"
            />
            <InputTextarea v-model="newCategory.metadescription" />
