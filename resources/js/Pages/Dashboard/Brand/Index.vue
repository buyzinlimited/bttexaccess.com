    ...
    <Modal id="addBrand" v-vb-is:modal>
      <div>
        ...
        <form @submit.prevent="addBrand">
          <div class="mb-3">
            <InputLabel for="name" value="Brand Name" class="d-block mb-2" />
          ...
          <div class="mb-3">
            ...
            <InputTextarea v-model="newBrand.metadescription" />
    ...
    <Modal id="editBrand" v-vb-is:modal>
      <div class="category-add">
        ...
        <form @submit.prevent="updateBrand(newBrand.id)">
          ...
          <div class="mb-3">
            <InputLabel for="slug" value="Brand URL" class="d-block mb-2" />
