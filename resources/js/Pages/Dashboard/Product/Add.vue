...
<template>
  ...
  <AuthenticatedLayout>
    <div class="row product-create-tab">
      <div class="col-lg-3">
        <div
          class="nav flex-column nav-pills bg-white shadow"
          id="v-pills-tab"
          role="tablist"
        ...
        >
          <button
            ...
            id="v-pills-td-tab"
            data-bs-toggle="pill"
            data-bs-target="#v-pills-td"
            type="button"
            role="tab"
            aria-controls="v-pills-td"
            aria-selected="true"
          >
          ...
          <button
            ...
            id="v-pills-bg-tab"
            data-bs-toggle="pill"
            data-bs-target="#v-pills-bg"
            type="button"
            role="tab"
            aria-controls="v-pills-bg"
            aria-selected="false"
          >
            Brand & Category
          </button>
          ...
          <button
            class="nav-link"
            id="v-pills-spaci-tab"
            data-bs-toggle="pill"
            data-bs-target="#v-pills-spaci"
            type="button"
            role="tab"
            aria-controls="v-pills-spaci"
            aria-selected="false"
          >
            Spacification
          </button>
          <button
            class="nav-link"
            id="v-pills-warranty-tab"
            data-bs-toggle="pill"
            data-bs-target="#v-pills-warranty"
            type="button"
            role="tab"
            aria-controls="v-pills-warranty"
            aria-selected="false"
          >
            Warranty
          </button>
      ...
      <div class="col-lg-9">
        <div
          class="bg-white shadow d-flex align-items-center justify-content-between gap-3 py-2 px-1 mb-3"
        >
          <div>
          ...
          <div class="d-flex align-items-center gap-2">
            <button
              class="button-primary button-primary--outline"
              @click="resetForm"
            >
              Cencel
            </button>
            <button class="button-primary" @click="addProduct">
              <div
                v-if="loading"
                class="spinner-border pinner-border-sm"
                role="status"
              >
        ...
        <div class="tab-content" id="v-pills-tabContent">
          <div
            ...
            id="v-pills-td"
            role="tabpanel"
            aria-labelledby="v-pills-td-tab"
            tabindex="0"
          >
            <div class="p-4 bg-white shadow mb-4">
              ...
              <div class="editor_content">
                <InputLabel
                  ...
                  class="text-dark fw-medium mb-2 fs-4"
                />
                <InputTextarea v-model="form.metadescription" />
          ...
          <div
            ...
            id="v-pills-bg"
            role="tabpanel"
            aria-labelledby="v-pills-bg-tab"
            tabindex="0"
          >
          ...
          >
            <div class="p-4 bg-white shadow mb-4">
              ...
              <ul style="list-style: disc" class="ps-4 mb-4">
                ...
                <li>300 * 200 Size</li>
                <li>
                  Allowed types: <span class="primary-color"> JPG</span>,
                  <span class="primary-color">JPEG</span>,
                  <span class="primary-color">PNG</span>.
                </li>
              </ul>
                        ...
                        >
                          ...
                          <g id="SVGRepo_iconCarrier">
                            ...
                            <path
                              ...
                              fill="#$secondary-color: var(--secondary-color, #D74825);"
                            ></path>
                          </g>
                        </svg>
                      </span>
          ...
          <div
            ...
            id="v-pills-spaci"
            role="tabpanel"
            aria-labelledby="v-pills-spaci-tab"
            tabindex="0"
          >
            <div class="p-4 bg-white shadow mb-4 editor_content">
              <InputLabel
